...
#include "ZXWaitTask.generated.h"

enum class EStateTreeRunStatus : uint8;
struct FStateTreeTransitionResult;

USTRUCT()
struct FZXWaitTaskInstanceData
{
	GENERATED_BODY()
 ...
 */
USTRUCT(meta = (DisplayName = "ZX Wait Task"))
struct FZXWaitTask : public FStateTreeTaskCommonBase
{
	GENERATED_BODY()

	using FInstanceDataType = FZXWaitTaskInstanceData;
